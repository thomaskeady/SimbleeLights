...
void createMainScreen()
{
  ...
  SimbleeForMobile.drawText(SimbleeForMobile.screenWidth / 2 - 22, 28, "Main", RED, 20);
  ...
  scanner_but = SimbleeForMobile.drawButton(firstButY, firstButX, but3width, "Scanner", BLACK);
  ...
  int sliderHeight = 50;
  int textHeight = 20;
  int speedXBuffer = SimbleeForMobile.screenWidth / 2 - 26;
  int brightnessXBuffer = SimbleeForMobile.screenWidth / 2 - 41;
  int minusHeight = -6;

  // Speed
  SimbleeForMobile.drawText(speedXBuffer, sliderYstart, "Speed", BLACK);
  speed_slider = SimbleeForMobile.drawSlider(sliderLeftPad, sliderYstart + textHeight + minusHeight, sliderWidth, 0, 255);
  speed_field = SimbleeForMobile.drawTextField(sliderLeftPad + sliderWidth + fieldLeftPad, sliderYstart + textHeight + minusHeight, fieldWidth, 255, "", WHITE, DARK_GRAY);

  // Brightness
  SimbleeForMobile.drawText(brightnessXBuffer, sliderYstart + textHeight + sliderHeight + minusHeight * 2, "Brightness", BLACK);
  brightness_slider = SimbleeForMobile.drawSlider(sliderLeftPad, sliderYstart + textHeight * 2 + sliderHeight + minusHeight * 2, sliderWidth, 0, 255);
  brightness_field = SimbleeForMobile.drawTextField(sliderLeftPad + sliderWidth + fieldLeftPad, sliderYstart + textHeight * 2 + sliderHeight + minusHeight * 2, fieldWidth, 255, "", WHITE, DARK_GRAY);

  // Colors
  sliderLeftPad = 25;
  sliderYstart = sliderYstart + textHeight * 2 + sliderHeight * 2 + minusHeight;
  sliderTextXPad = 6;
  sliderTextWidth = 30;
  sliderWidth = 175;
  fieldLeftPad = 15;
  ...
  rslider = SimbleeForMobile.drawSlider(sliderLeftPad + sliderTextWidth, sliderYstart, sliderWidth, 0, 255);
  rtextfield = SimbleeForMobile.drawTextField(sliderLeftPad + sliderTextWidth + sliderWidth + fieldLeftPad, sliderYstart, fieldWidth, 255, "", WHITE, DARK_GRAY);

  SimbleeForMobile.drawText(sliderLeftPad, sliderYstart + sliderTextXPad + sliderHeight, "G:", WHITE);
  gslider = SimbleeForMobile.drawSlider(sliderLeftPad + sliderTextWidth, sliderYstart + sliderHeight, sliderWidth, 0, 255);
  gtextfield = SimbleeForMobile.drawTextField(sliderLeftPad + sliderTextWidth + sliderWidth + fieldLeftPad, sliderYstart + sliderHeight, fieldWidth, 255, "", WHITE, DARK_GRAY);

  SimbleeForMobile.drawText(sliderLeftPad, sliderYstart + sliderTextXPad + sliderHeight * 2, "B:", WHITE);
  bslider = SimbleeForMobile.drawSlider(sliderLeftPad + sliderTextWidth, sliderYstart + sliderHeight * 2, sliderWidth, 0, 255);
  btextfield = SimbleeForMobile.drawTextField(sliderLeftPad + sliderTextWidth + sliderWidth + fieldLeftPad, sliderYstart + sliderHeight * 2, fieldWidth, 255, "", WHITE, DARK_GRAY);
